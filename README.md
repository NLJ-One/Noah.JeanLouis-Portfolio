...
- **Scripts différés** : `defer` sur les scripts JavaScript
...
├── Profil.html            # Profil & compétences
├── Mes projet.html        # Galerie de projets
├── Me retrouver.html      # Réseaux sociaux
├── 3D.html                # Projets 3D
├── graph.html             # Projets graphiques
├── Ux.html                # Projets UI/UX
...
│   ├── 3D.css             # Projets 3D
│   ├── graph.css          # Projets graphiques
│   ├── Ui.css             # UI/UX
│   └── PA.css             # Projets appliqués
│
├── JS/
│   └── scroll.js          # Animations scroll
│
...
- **Custom Properties** - Variables CSS pour design system
...
```css
/* Backgrounds */
--bg-primary: #0d0d0d      /* Noir profond */
--bg-secondary: #1a1a1a    /* Noir secondaire */

/* Accents */
--accent-blue: #3b82f6     /* Tech Blue */
--accent-purple: #8b5cf6   /* Design Purple */
--accent-violet: #a855f7   /* Accent Violet */
...
**URL de production :** [jeanlouisnoah.netlify.app](https://jeanlouisnoah.netlify.app/)
...
- [ ] Blog/Articles sur le design
- [ ] Animations GSAP avancées
- [ ] Formulaire de contact avec validation
- [ ] Optimisation WebP pour les images
